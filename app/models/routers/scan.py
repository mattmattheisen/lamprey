...
GET /api/scan          — trigger scan now, return ScanResult
GET /api/latest        — return cached last ScanResult (no re-scan)
GET /api/watchlist     — return current watchlist tickers
"""
